...
public class DeliveryManagerController {
    ...
    public ResponseEntity<DeliveryManagerResponse> updateManager(
        ...
        return ResponseEntity.ok(managerService.updateManager(managerId, request, userId, role, hubId));
    }
    ...
    public ResponseEntity<DeliveryManagerResponse> changeManagerStatus(
        ...
        return ResponseEntity.ok(managerService.changeManagerStatus(managerId, request, userId, role, hubId));
    }
